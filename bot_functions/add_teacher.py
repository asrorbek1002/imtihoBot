...
def handle_user_id(update: Update, context: CallbackContext) -> None:
    ...
    if result:
        ...
        conn.commit()
        update.message.reply_text(f"Foydalanuvchi  {result[1]} muvaffaqiyatli o'qituvchiga o'zgartirildi.")
...
def handle_user_id_student(update: Update, context: CallbackContext) -> None:
    ...
    if result:
        ...
        conn.commit()
        update.message.reply_text(f"Foydalanuvchi  {result[1]} muvaffaqiyatli o'qituvchilikdan o'chirildi.")
